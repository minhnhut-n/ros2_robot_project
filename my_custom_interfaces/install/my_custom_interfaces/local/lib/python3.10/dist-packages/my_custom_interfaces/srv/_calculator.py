...
class Metaclass_Calculator(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_custom_interfaces.srv.Calculator')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_custom_interfaces.srv import _calculator
...
class Calculator(metaclass=Metaclass_Calculator):
    from my_custom_interfaces.srv._calculator import Calculator_Request as Request
    from my_custom_interfaces.srv._calculator import Calculator_Response as Response
