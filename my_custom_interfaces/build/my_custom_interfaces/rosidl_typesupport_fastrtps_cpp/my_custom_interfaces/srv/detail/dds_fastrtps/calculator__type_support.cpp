...
#include "my_custom_interfaces/srv/detail/calculator__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_custom_interfaces::srv::Calculator_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_custom_interfaces::srv::Calculator_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_interfaces::srv::Calculator_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_custom_interfaces::srv::Calculator_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_custom_interfaces::srv::Calculator_Request *>(
    untyped_ros_message);
...
{
  return &my_custom_interfaces::srv::typesupport_fastrtps_cpp::_Calculator_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interfaces, srv, Calculator_Request)() {
  return &my_custom_interfaces::srv::typesupport_fastrtps_cpp::_Calculator_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_custom_interfaces
cdr_serialize(
  const my_custom_interfaces::srv::Calculator_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_custom_interfaces::srv::Calculator_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_custom_interfaces::srv::Calculator_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_custom_interfaces::srv::Calculator_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_custom_interfaces::srv::Calculator_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_custom_interfaces::srv::typesupport_fastrtps_cpp::_Calculator_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interfaces, srv, Calculator_Response)() {
  return &my_custom_interfaces::srv::typesupport_fastrtps_cpp::_Calculator_Response__handle;
}
...
{
  return &my_custom_interfaces::srv::typesupport_fastrtps_cpp::_Calculator__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interfaces, srv, Calculator)() {
  return &my_custom_interfaces::srv::typesupport_fastrtps_cpp::_Calculator__handle;
}
